...
**글쓰기**: `write-plainly`(한국어·영어 문체).

**pstack**: `architect`, `arena`, `blast-radius`, `create-verification-skill`, `how`, `interrogate`, `maintain-verification-skill`, `principles`, `reflect`, `show-me-your-work`, `swarm`, `tdd`, `why`. 원본 이름을 유지해 upstream을 따라간다.
