...
| orphan | ppid 1, and the executable or the script it runs (its first non-option argument) lies under a path in `reap.orphan_paths`, ≥ N hours | anything else | same |
