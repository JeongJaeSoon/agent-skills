<!-- pstack-vendor: cursor/plugins@b42effe0aa50 pstack/skills/reflect/references/divergent-reviewer.md (adapted) MIT (c) 2026 Lauren Tan -->
...
- `Skill` tool calls, and `Read` tool calls against any `SKILL.md` file (project `.claude/skills/`, user-level `~/.claude/skills/`, or plugin-installed paths under `~/.claude/plugins/`)
